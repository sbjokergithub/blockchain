...
public class BlockChain {
	...
	public static void main(String[] args) {
		...
		System.out.println("xiongweigang");
		Initialize();
		System.out.println("郭庆爽");
	...
	public static void virtualSendTrade() {
		pbftHashMap = new HashMap<String, String>();
	...
	public static void pbftVote() {
		tradeHashMap = new HashMap<String, String>();
		for (Map.Entry<String, Fragmentation> entry : fragmentationList.entrySet()) {
			Fragmentation fragmentation = entry.getValue();
...
//		}
	...
	public static void Initialize() {
        ...
        System.out.println("fragmentationList:");
		...
		System.out.println("transaction:王松"+transaction);
		//排序
		Comparator<Trading> comparator = new Comparator<Trading>(){
		     public int compare(Trading s1, Trading s2) {
		      //先排年龄
